...
export default function SearchComp(){
    return(
      ...
      <div className=" align-text-top  font-sans font-custom text-4xl  ml-80">
        Find your <strong className=' text-green-600'>dream company!</strong>
      </div>
      ...
      <form action="" method="">
        ...
        rounded-[8px] gap-5 bg-white p-5 shadow-lg shadow-gray-700">
          ...
          <div className="flex items-center gap-2">
            ...
            <input type="text" className="bg-transparent focus:outline-none w-full" placeholder="Name Company ..." />
